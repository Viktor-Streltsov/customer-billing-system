...
import classes from "./totalTarif.module.css"
                ...
                <div className={classes.conteiner_blocks}>
                    <div className={classes.block_infa}>
                        ...
                        <div className={classes.block_cash}>
                            <span className={classes.cash}><span className={classes.many}>450</span>som/мес</span>
                        </div>
