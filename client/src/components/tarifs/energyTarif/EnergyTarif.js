...
import classes from "./energyTarif.module.css"
                ...
                <div className={classes.conteiner_blocks}>
                    <div className={classes.block_infa}>
                        ...
                        <div className={classes.block_cash}>
                            <span className={classes.cash}><span className={classes.many}>600</span>som/мес</span>
                        </div>
                        <div className={classes.block_btn}>
                            <a href="/#"><span>Подключить</span></a>
                        </div>
                    </div>
