...
import classes from "./ultraTarif.module.css"
                ...
                <div className={classes.conteiner_blocks}>
                    <div className={classes.block_infa}>
                        ...
                        <div className={classes.block_cash}>
                            <span className={classes.cash}><span className={classes.many}>900</span>som/мес</span>
                        </div>
